...
public class MediaDetailActivity extends AppCompatActivity implements EasyVideoProgressCallback,EasyVideoCallback {
  ...
  //  private TextureVideoView mVideoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        backImage  = (ImageView)findViewById(R.id.backdrop);
                ...
                if (notificationDataModel.getSuccess().equalsIgnoreCase("True")) {
                    ...
                    if(notificationDataModel.getFinalAry().get(0).getFileType().equals("Test") || notificationDataModel.getFinalAry().get(0).getFileType().equals("Text")){
                       ...
                       // mVideoView.setVisibility(View.GONE);
                        ...
                        imageUrl = notificationDataModel.getFinalAry().get(0).getFilePath();
