...
import static com.loksarkar.ui.bottomSheetView.MenuSheetView.MenuType.GRID;
import static com.loksarkar.ui.bottomSheetView.MenuSheetView.MenuType.LIST;
...
public class MenuSheetView extends FrameLayout {
    ...
    public MenuSheetView(final Context context, final MenuType menuType, @Nullable final CharSequence title, final OnMenuItemClickListener listener) {
        ...
        ViewCompat.setElevation(this, AppUtils.dp2px(getContext(), 16f));
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setOutlineProvider(new AppUtils.ShadowOutline(w, h));
        }
    }
    ...
    public void setTitle(CharSequence title) {
        if (!TextUtils.isEmpty(title)) {
            ...
            absListView.setPadding(absListView.getPaddingLeft(), originalListPaddingTop + AppUtils.dp2px(getContext(), 8f), absListView.getPaddingRight(), absListView.getPaddingBottom());
        }
    }
