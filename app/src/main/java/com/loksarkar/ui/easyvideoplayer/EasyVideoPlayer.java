package com.loksarkar.ui.easyvideoplayer;
  ...
  private final Runnable mUpdateCounters =
      new Runnable() {
        ...
        public void run() {
          ...
          mLabelPosition.setText(Util.getDurationString(mPlayerPosition, false));
          mLabelDuration.setText(Util.getDurationString(dur - mPlayerPosition, true));
          mSeeker.setProgress(mPlayerPosition);
          mSeeker.setMax(dur);
