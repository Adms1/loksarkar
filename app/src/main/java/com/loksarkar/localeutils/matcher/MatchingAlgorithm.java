...
public interface MatchingAlgorithm {
    ...
    /**
     * Method that implements the algorithm to find two matching Locales between a list_item_complaint of supported and system Locales.
     *
     * @param supportedLocales a list_item_complaint of your app supported locales
     * @param systemLocales    a list_item_complaint of the configured  locales in system preferences
