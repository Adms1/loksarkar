...
public abstract class EndlessRecyclerViewAdapter<T, VHT extends RecyclerView.ViewHolder, FHT extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected final List<MediaBulletinModel.FinalArray> data;
    private final Handler mainHandler;
    private FHT footerViewHolder;
    private boolean footerVisible = false;

    protected EndlessRecyclerViewAdapter(List<MediaBulletinModel.FinalArray> data, Context context) {
    ...
    public void addNewPage(List<MediaBulletinModel.FinalArray> page) {
        this.footerVisible = false;
